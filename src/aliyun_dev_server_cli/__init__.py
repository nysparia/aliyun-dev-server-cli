...
def main():
    ...
    for i, p in enumerate(prices):
        _log.info(
            ...
            i,
            p.price.trade_price,
            cpu_count=p.instance_type.cpu_core_count,
            cpu_freq=p.instance_type.cpu_speed_frequency,
            cpu_turbo_freq=p.instance_type.cpu_turbo_frequency or None,
            arch=p.instance_type.cpu_architecture,
            mem_gib=p.instance_type.memory_size,
            zone_id=p.zone_id,
            type_id=p.instance_type.instance_type_id,
            category=p.instance_type.instance_category
        )
